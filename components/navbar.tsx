...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 ${isScrolled ? "bg-[#001529]/90 backdrop-blur-sm py-2 shadow-md" : "bg-transparent py-4"
        }`}
    >
